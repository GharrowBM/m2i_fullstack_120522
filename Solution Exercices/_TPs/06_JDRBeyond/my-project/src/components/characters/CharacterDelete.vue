    ...
    <form @submit.prevent="onSubmit">
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col">
                        <select name="race" id="race" class="form-select" v-model="c.race" disabled>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col">
                        <select name="gender" id="gender" class="form-select" v-model="c.gender" disabled>
            ...
            <div class="col">
                <div class="row mb-2">
                    ...
                    <div class="col">
                        <input type="text" class="form-control" v-model="c.player" readonly>
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-4">
                    ...
                    <div class="col">
                        <select name="charClass" id="charClass" class="form-select" v-model="c.charClass" disabled>
        ...
        <div class="row text-center g-2" v-if="c.stats">
            <div class="col">
                <div class="border border-info rounded py-4 d-flex flex-column">
                    ...
                    <input type="text" class="form-control w-50 mx-auto text-center mt-2 col-stat"
                        v-model.number="c.stats.str" readonly>
                </div>
            </div>
            <div class="col">
                <div class="border border-info rounded py-4 d-flex flex-column">
                    <span>DEX</span>
                    <input type="text" class="form-control w-50 mx-auto text-center mt-2" v-model.number="c.stats.dex" readonly>
            ...
            <div class="col">
                <div class="border border-info rounded py-4 d-flex flex-column">
                    <span>CON</span>
                    <input type="text" class="form-control w-50 mx-auto text-center mt-2" v-model.number="c.stats.con" readonly>
            ...
            <div class="col">
                <div class="border border-info rounded py-4 d-flex flex-column">
                    <span>INT</span>
                    <input type="text" class="form-control w-50 mx-auto text-center mt-2" v-model.number="c.stats.int" readonly>
            ...
            <div class="col">
                <div class="border border-info rounded py-4 d-flex flex-column">
                    <span>WIS</span>
                    <input type="text" class="form-control w-50 mx-auto text-center mt-2" v-model.number="c.stats.wis" readonly>
            ...
            <div class="col">
                <div class="border border-info rounded py-4 d-flex flex-column">
                    <span>CHA</span>
                    <input type="text" class="form-control w-50 mx-auto text-center mt-2" v-model.number="c.stats.cha" readonly>
                </div>
            </div>
        </div>
        <hr>
...
export default {
    ...
    methods: {
        onSubmit() {
            axios.delete(`https://vue-m2i-jdr-beyond-default-rtdb.europe-west1.firebasedatabase.app/characters/${this.c.id}.json`).then(() => {
